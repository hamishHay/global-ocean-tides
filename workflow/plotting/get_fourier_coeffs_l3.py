...
def main():
    save_file = h5py.File('galilean_coefficients_bad.h5','w')
        ...
        for i in range(len(forcings[j])):
            ...
            if forcing is not 'eccentricity' and forcing is not 'obliquity':
                ...
                if forcing is "eccentricity":
                    ...
                    # e1 = 0.0000000000001
                    # o1 = np.radians(0.01)
                    U = potential.potential_kaula(3, 0, 0, M, a1, R1, n1, e1, o1, t, colats, lons)
                    ...
                    print(0, np.amax(abs(U)))
                    for q in range(1, 6+1):
                        U = potential.potential_kaula(3, 0, q, M, a1, R1, n1, e1, o1, t, colats, lons)
                        print(q, np.amax(abs(U)))
